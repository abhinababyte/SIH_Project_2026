    ...
    <div className="min-h-screen bg-slate-950 text-slate-300 font-sans selection:bg-orange-500/30 flex flex-col relative overflow-x-hidden">
        ...
        <div className="px-3 sm:px-6 flex items-center justify-between w-full h-full">
          <div className="flex items-center h-full min-w-0">
            ...
            <div className="pl-2.5 sm:pl-4 min-w-0">
              <h1 className="text-lg font-sans font-extrabold text-white tracking-wide whitespace-nowrap">
                HillShield
              </h1>
              <p className="text-[9px] sm:text-[10px] text-slate-400 font-mono tracking-wider uppercase hidden sm:block truncate">
                Natural Disaster Detection Intelligence
              </p>
            </div>
          </div>
      ...
      <div className="h-8 bg-rose-500/10 border-b border-rose-500/20 flex items-center overflow-hidden relative z-40">
        <div className="absolute left-0 top-0 bottom-0 w-24 sm:w-32 bg-[#0f0a10] z-20 flex items-center pl-3 sm:pl-6 pr-2 sm:pr-4 shadow-[10px_0_15px_-3px_rgba(15,10,16,1)] border-r border-rose-500/20">
          <span className="text-[9px] sm:text-[10px] font-mono font-bold text-rose-500 tracking-wider">
            LIVE FEED
          </span>
        </div>
      ...
      <main className="flex-1 relative flex flex-col lg:flex-row min-h-[calc(100vh-6rem)] lg:min-h-[800px]">
        ...
        <div className="flex-1 p-4 sm:p-8 lg:p-16 xl:p-24 relative z-20 flex flex-col justify-center pointer-events-none">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 mb-3 px-3 py-3 rounded-full bg-red-500/10 border border-red-500/30 backdrop-blur-sm shadow-[0_0_12px_rgba(239,68,68,0.15)] transition-colors hover:bg-red-500/20 hover:border-red-500/50">
              <span className="inline-block w-2 h-2 rounded-full bg-red-500 animate-pulse"></span>
              <span className="text-lg font-medium uppercase tracking-wider text-red-400">Helpline:</span>
              <a href="tel:1077" className="text-lg font-mono font-bold text-white hover:text-red-300">1077</a>
              <span className="text-zinc-600">/</span>
              <a href="tel:112" className="text-lg font-mono font-bold text-white hover:text-red-300">112</a>
            </div>
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl xl:text-8xl font-extrabold text-white tracking-tight leading-[1.05] mb-4 sm:mb-6 font-playfair drop-shadow-[0_4px_10px_rgba(0,0,0,0.8)]">
              Stay ahead of <br />
              <span className="text-orange-500 drop-shadow-[0_0_15px_rgba(249,115,22,0.5)]">
                the surge.
              </span>
            </h1>
            ...
            <p className="text-sm sm:text-lg text-slate-300 max-w-md leading-relaxed mb-8 sm:mb-16 font-medium drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
              Empowering citizens and first responders with real-time flood intelligence, safe
              evacuation routing, and instant crisis coordination.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-8 mt-6 sm:mt-8 border-t border-white/20 pt-6 sm:pt-8 max-w-lg bg-slate-950/40 p-4 sm:p-6 rounded-2xl backdrop-blur-sm border-l">
              <div>
                <div className="text-2xl sm:text-3xl font-bold text-white mb-1 drop-shadow-md">
                  05
                </div>
                <div className="text-[9px] font-mono tracking-widest uppercase text-slate-400 drop-shadow-md">
                  Hill Sectors
                  <br />
                  Connected
                </div>
              ...
              <div className="flex items-center gap-3 inline-flex w-full sm:w-auto pt-3 sm:pt-0 border-t border-white/10 sm:border-t-0">
                <ShieldCheck className="size-5 sm:size-6 text-emerald-500 drop-shadow-md" />
                <div className="text-[9px] font-mono tracking-widest uppercase text-emerald-400 font-bold drop-shadow-md">
          ...
          <div className="w-full bg-slate-950/80 backdrop-blur-xl border border-white/10 shadow-2xl rounded-2xl p-5 sm:p-8 lg:p-10">
            <div className="flex items-center gap-2 mb-6 sm:mb-8">
              ...
              <div className="ml-auto flex items-center gap-1.5">
                ...
                <span className="text-[9px] font-mono tracking-widest uppercase text-emerald-500">
                  Encrypted
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center border-b border-white/10 mb-6 sm:mb-8">
              <button
                ...
                className={cn(
                  "flex-1 pb-4 text-sm font-semibold transition-colors relative",
            ...
            <form onSubmit={handleAuth} className="flex flex-col gap-5">
                ...
                <>
                  <div className="flex flex-col gap-2 mb-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3">
                      <button
                        ...
                        className={cn(
                          "flex flex-col gap-1.5 sm:gap-2 p-3 sm:p-4 rounded-xl border text-left transition-all relative overflow-hidden",
                          role === "resident"
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <User
                            className={cn(
                              "size-4",
                              role === "resident" ? "text-orange-500" : "text-slate-400",
                            )}
                          />
                          <span className="text-sm font-semibold text-white">Resident</span>
                        </div>
                        <p className="text-[10px] text-slate-400 leading-relaxed">
                          Evacuation alerts, shelter routes, and local river updates.
                        </p>
                      </button>
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <Radio
                            className={cn(
                              "size-4",
                              role === "responder" ? "text-orange-500" : "text-slate-400",
                            )}
                          />
                          <span className="text-sm font-semibold text-white">First Responder</span>
                        </div>
                        <p className="text-[10px] text-slate-400 leading-relaxed">
                          Rainfall radar, dam discharge, and village broadcast controls.
                        </p>
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      className="w-full bg-[#121826]/50 border border-white/10 rounded-lg px-4 py-3 text-sm text-white focus:outline-none focus:border-orange-500/50 focus:ring-1 focus:ring-orange-500/50 transition-all placeholder:text-slate-600"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full mt-4 bg-orange-600 hover:bg-orange-500 text-white font-bold py-3.5 px-4 rounded-lg flex items-center justify-between transition-colors focus:outline-none shadow-[0_0_15px_rgba(234,88,12,0.4)] disabled:opacity-70"
              >
                <span>
                  {isLoading
                    ? "Authenticating..."
      ...
      <footer className="bg-slate-950/95 backdrop-blur-xl border-t border-white/5 py-6 sm:py-8 px-4 sm:px-6 lg:px-12 relative z-40 flex flex-col gap-5 sm:gap-6 safe-bottom">
        ...
        <div className="text-center md:text-left text-[11px] font-mono tracking-wider text-slate-500 flex flex-col md:flex-row items-center justify-between border-t border-white/5 pt-6">
          <span className="hidden md:inline-block">
            Central Emergency Node: <strong className="text-white">ACTIVE</strong>
          </span>
