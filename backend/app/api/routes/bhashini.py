...
MOCK_TRANSLATIONS = {
    ...
    "bn": {
        ...
        "Community verified: Bridge washout at River Road. DO NOT use this route.": "সম্প্রদায় যাচাইকৃত: রিভার রোডে সেতু ভেসে গেছে। এই রাস্তাটি ব্যবহার করবেন মহাশয়।",
...
async def translate_text(req: TranslationRequest):
    ...
    if lang == "en":
        return TranslationResponse(
            original_text=req.text, translated_text=req.text, language="en"
        )
